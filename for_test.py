...
f_write = open("test_check.tsv", "w",-1, "utf-8", newline='') 
...
for i,line in enumerate(line_list):
    ...
    A = get_subject_in_sentence(a_line)[0] == line[4]
    B = get_subject_in_sentence(b_line)[0] == line[7]
    wr.writerow(['test-'+str(i+1), A, B])